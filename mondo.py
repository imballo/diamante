...
class CasellaInizio(CasellaMappa):
    ...
    def descrizione(self):
        if self.visitata:
            ...
            s=s+"""
Sei Jonatan e mentre perlustri una grotta in fondo al
mare trovi dei piccoli frammenti di cristallo.
"""
            return s
...
class CasellaNoiosa(CasellaMappa):
    ...
    def descrizione(self):
        if self.visitata:
            d1="\nTi annoi perlustrando la grotta in cerca del tesoro.\n"
            d2="\nSei già stato qui...non ti sarai mica perso?\n"
        else:
            d1="\nQuesta è una zona noiosa.\n"
...
class CasellaFine(CasellaMappa):
    ...
    def descrizione(self):
        ...
        d1= \
"""
Dopo aver combattuto tutte le prove e sconfitto tutti i mostri sei arrivto al tesoro che da tanto desideravi.
"""
        d2=d1
        d3=d1            
...
class CasellaBuca(CasellaFine):
    ...
    def descrizione(self):
        d1 = """
Cadi in una trappola da cui non riesci a risalire. La tua avventura finisce qui.
"""
        d2 = """
Una trappola mortale ti uccide. La tua avventura finisce qui.
"""
        return choice([d1,d2])
...
class CasellaOro(CasellaMappa):
    ...
    def descrizione(self):
        if self.oro>0:
            return "\nRaccogli l'oro che qualcuno ha perso lungo il percorso.\n"
        else:
