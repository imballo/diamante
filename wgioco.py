...
nomi_mappe = {'Una bella mappa.':'./mappe/c-aa.csv',
              'Una mappa bella.':'./mappe/a-af.csv'}
...
class Schermo(BoxLayout):
    def chiudi(self,dt):
        print("\nIl gruppo acabot ti ringrazia per avere giocato a questa avventura.")        
    ...
    def azione(self,instance):
        ...
        if azione in lista_azioni or azione in ['continua a giocare','crediti','esci','sono sicuro']:
            ...
            print("\nBenvenuto, il gruppo acabot è lieto di presentarti questa avventura.")
